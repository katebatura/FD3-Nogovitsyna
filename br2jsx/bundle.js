...
var BR2JSX = function (_React$Component) {
    ...
    _createClass(BR2JSX, [{
        ...
        value: function render() {
            ...
            var breaks = ['<br/>', '<br />'];
            var changedText = this.state.text;
            ...
            var arr = [changedText[0]];
            for (var _v = 1; _v < changedText.length; _v++) {
                arr.push(_react2.default.createElement('br', { key: _v }));
                arr.push(changedText[_v]);
            }

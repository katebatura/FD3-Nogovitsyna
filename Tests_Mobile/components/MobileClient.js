  ...
  render() {
    ...
    return (
      <tr>
        ...
        <td>
          <input type = "button" value = "Редактировать" onClick = {this.editClient} id = "editClientButton" />          
        </td>
        <td>
          <input type = "button" value = "Удалить" onClick = {this.deleteClient} id = "deleteClientButton" />          
        </td>
      </tr>
    );
